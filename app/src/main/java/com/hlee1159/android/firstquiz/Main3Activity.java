...
public class Main3Activity extends GroundActivity {
    ...
    public void onBackPressed() {
        ...
        builder.setPositiveButton("초보자 단계로 돌아가기", new DialogInterface.OnClickListener() {
            @Override
    ...
    public void init() {
        questions = new String[]{"ㄱㄴ", "ㅈㅅㄱ", "ㄱㄹㄱ", "ㅎㅈㄹ", "ㅈㄱㄷㅊ", "ㅅㄴㅂㄹ", "ㅈㅈㅂㄹ", "ㅁㅅㅈㅂ", "ㅈㅇ", "ㅂㄹㅊㄱ"};
        answers = new String[]{"강남", "잡생각", "겨루기", "한자리", "자가당착", "시나브로", "주전부리", "물수제비", "조언", "벼락치기"};
        hint1 = new String[]{"교육", "상념","승부", "벼슬", "모순", "조금씩", "먹을거리", "돌", "도움말", "날림"};
        hint2 = new String[]{"스타일", "쓸데없이","다투다", "직위", "스스로", "사이사이", "심심풀이", "물결", "선배", "서둘러"};
        hint3 = new String[]{"부자", "생각", "태권도", "~하다", "", "", "간식", "튕기다", "", "시험"};
